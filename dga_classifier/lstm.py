...
def run(max_epoch=25, nfolds=10, batch_size=128):
    ...
    for fold in range(nfolds):
        ...
        for ep in range(max_epoch):
            ...
            t_auc = metrics.roc_auc_score(y_holdout, t_probs)
            ...
            if t_auc > best_auc:
                ...
                out_data = {'y':y_test, 'labels': label_test, 'probs':probs, 'epochs': ep,
                            'confusion_matrix': metrics.confusion_matrix(y_test, probs > .5)}
...
run(max_epoch=25, nfolds=10, batch_size=128)